...
public class InitializationTest {
    ...
    protected static final List<String> NAV_BAR_NAMES = Arrays
        .asList("HOME", "CONTACT FORM", "SERVICE", "METALS & COLORS");
    protected static final List<String> BENEFIT_TEXTS = Arrays.asList("To include good practices\n"
        ...
        + "wish to get more…");
    protected static final List<String> LEFT_SIDE_BAR_MENU_ITEMS = Arrays
